...
void CZMQNotificationInterface::NotifyTransactionLock(const CTransactionRef &tx,
...
void CZMQNotificationInterface::NotifyInstantSendDoubleSpendAttempt(const CTransactionRef &currentTx,
