...
public:
    bool NotifyTransactionLock(const CTransactionRef &transaction,
...
public:
    bool
    NotifyInstantSendDoubleSpendAttempt(const CTransactionRef &currentTx, const CTransactionRef &previousTx) override;
};
