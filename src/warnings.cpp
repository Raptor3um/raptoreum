...
std::string GetWarnings(bool verbose)
{
    ...
    if (!CLIENT_VERSION_IS_RELEASE) {
        ...
        warnings_verbose = _("This is a pre-release test build - use at your own risk - do not use for mining or merchant applications");
    }
    ...
    if (fLargeWorkForkFound) {
        ...
        warnings_verbose += (warnings_verbose.empty() ? "" : warning_separator) + _("Warning: The Network does not appear to fully agree! Some miners addear to experiencing issues.");
        ...
        warnings_verbose += (warnings_verbose.empty() ? "" : warning_separator) + _("Warning: We do not appear to fully agree with our peers! You may need to upgrade, or other nodes may need to upgrade.");
    }
