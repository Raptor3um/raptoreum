...
public:
    ...
    //! A negative requirement uses the EXCLUSIVE_LOCKS_REQUIRED attribute,
    //! in conjuction with the ! operator, to indicate that
    //! a mutex should not be held.
...
// is locked (when it could not be determined otherwise).
