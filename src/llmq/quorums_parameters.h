...
static constexpr LLMQParams llmq200_2 = {
        .type = LLMQ_50_60,
        .name = "llmq_200_2",
        .size = 200,
        .minSize = 2,
...
static constexpr LLMQParams llmq3_60 = {
        .type = LLMQ_50_60,
        .name = "llmq_3_60",
        .size = 3,
        .minSize = 2,
...
static constexpr LLMQParams llmq5_60 = {
        .type = LLMQ_400_60,
        .name = "llmq_5_60",
        .size = 5,
        .minSize = 4,
...
static constexpr LLMQParams llmq5_85 = {
        .type = LLMQ_400_85,
        .name = "llmq_5_85",
        .size = 5,
        .minSize = 4,
...
static constexpr LLMQParams llmq20_60 = {
        .type = LLMQ_400_60,
        .name = "llmq_20_60",
        .size = 20,
        .minSize = 15,
...
static constexpr LLMQParams llmq20_85 = {
        .type = LLMQ_400_85,
        .name = "llmq_20_85",
        .size = 20,
        .minSize = 18,
...
static constexpr LLMQParams llmq10_60 = {
        .type = LLMQ_50_60,
        .name = "llmq_10_60",
        .size = 10,
        .minSize = 8,
...
static constexpr LLMQParams llmq40_60 = {
        .type = LLMQ_400_60,
        .name = "llmq_40_60",
        .size = 40,
        .minSize = 30,
...
static constexpr LLMQParams llmq40_85 = {
        .type = LLMQ_400_85,
        .name = "llmq_40_85",
        .size = 40,
        .minSize = 35,
