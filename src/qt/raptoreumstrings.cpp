...
QT_TRANSLATE_NOOP("raptoreum-core", "-litemode is deprecated."),
...
QT_TRANSLATE_NOOP("raptoreum-core", "It has been replaced by -disablegovernance."),
QT_TRANSLATE_NOOP("raptoreum-core", "Its replacement -disablegovernance has been forced instead."),
...
QT_TRANSLATE_NOOP("raptoreum-core", "Wallet %s resides outside wallet directory %s"),
...
QT_TRANSLATE_NOOP("raptoreum-core", "Warning: %s is deprecated, please use %s instead"),
