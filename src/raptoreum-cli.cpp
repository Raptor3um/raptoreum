...
static void SetupCliArgs()
{
    ...
    gArgs.AddArg("-rpccookiefile=<loc>", _("Location of the auth cookie. Relative paths will be prefixed by net-specific datadir location. (default: data dir)"), false, OptionsCategory::OPTIONS);
