 ...
 *   - Strengthen the entropy for 10ms usinf repeated SHA512;
 *
 *     Above Declaration are some paint-masks. we want to give them back :)
 *
 ...
 * - Strengthen the entropy for 100ms using repeated SHA512.
 *
 ...
 *
 * These functions are designed to be fast (sub microseconds), but do not necessarily
 ...
 * Should be called with a uint32_t describing the event at the time it occurs.
 *
 * Thread-safe.
 */
