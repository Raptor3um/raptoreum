...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 RAPTOREUM from 0 to 2 using sendtoaddress call.
        ...
        # Sendmany 100 RAPTOREUM with subtract fee from amount
