...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Assets', 'Blockchain', 'Control', 'Evo', 'Generating', 'Mining', 'Network', 'Raptoreum', 'Rawtransactions', 'Util']
